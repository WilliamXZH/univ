...
public class BorrowedItems implements Iterable<CatalogItem>  {
	...
	/**
	 * Returns an array containing all the items in this borrower.
	 *
	 * @return an array containing the items of this borrower.
	 */
	public CatalogItem[] getItems()  {

		return  (CatalogItem[]) this.items.toArray(new CatalogItem[0]);
	}
}
