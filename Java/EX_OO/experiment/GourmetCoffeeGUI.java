...
public class GourmetCoffeeGUI extends JPanel {
	...
	private JPanel getDataFieldsPanel(ArrayList<DataField> dataFields) {
		...
		left.setPreferredSize(new Dimension(100,(int)(0.9*productPanel.getHeight())));
		right.setPreferredSize(new Dimension((int)(0.5*productPanel.getWidth()),(int)(0.9*productPanel.getHeight())));
