...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        <td style="text-align:center;background-color:#f5f5f5;vertical-align:middle;">菜肴名称</td>
        <td><input type="text" name="cname" id="cname" value="" /><span id="cnametip" style="color:red; margin-left: 10px;"></span></td>
    </tr>
    <tr>
        <td style="text-align:center;background-color:#f5f5f5;vertical-align:middle;">菜肴做法</td>
    ...
    <tr>
        <td style="text-align:center;background-color:#f5f5f5;vertical-align:middle;">所需原料</td>
