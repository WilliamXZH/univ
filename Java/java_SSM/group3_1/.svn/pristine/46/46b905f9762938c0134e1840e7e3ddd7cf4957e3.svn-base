	...
	function showData(result) {
		...
		for (var i = 0; i < result.length; i++) {
			...
			newNode.innerHTML = "<td>"
					...
					+ "</td>"
					+ "<td action-able>"
					+ "<a href='text.html'><input class='orderSelectButton' type='button' value='继续支付'/><a><br/>"
					+ "<a href='text.html'><input class='orderSelectButton' type='button' value='取消订单'/></a>"
					+ "</td>";
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-8 col-sm-9">
						...
						<ul>
							...
							<li><a href="../userweb/NomalQuestion">常见问题</a>
							</li>
