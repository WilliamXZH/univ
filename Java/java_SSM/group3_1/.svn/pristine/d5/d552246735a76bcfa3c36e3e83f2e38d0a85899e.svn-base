 ...
 * generated in the pers.william.sms package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetKeFuResult_QNAME = new QName("http://106.ihuyi.cn/", "GetKeFuResult");
    ...
    private final static QName _GetReportResult_QNAME = new QName("http://106.ihuyi.cn/", "GetReportResult");
    private final static QName _QueryResult_QNAME = new QName("http://106.ihuyi.cn/", "QueryResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pers.william.sms
     * 
     */
    ...
    /**
     * Create an instance of {@link GetKeFuResult }
     * 
     */
    public GetKeFuResult createGetKeFuResult() {
        return new GetKeFuResult();
    }
    ...
    /**
     * Create an instance of {@link GetKeFuResponse }
     * 
     */
    public GetKeFuResponse createGetKeFuResponse() {
        return new GetKeFuResponse();
    }
    ...
    /**
     * Create an instance of {@link GetKeFu }
     * 
     */
    public GetKeFu createGetKeFu() {
        return new GetKeFu();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetKeFuResult }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://106.ihuyi.cn/", name = "GetKeFuResult")
    public JAXBElement<GetKeFuResult> createGetKeFuResult(GetKeFuResult value) {
        return new JAXBElement<GetKeFuResult>(_GetKeFuResult_QNAME, GetKeFuResult.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://106.ihuyi.cn/", name = "GetReportResult")
