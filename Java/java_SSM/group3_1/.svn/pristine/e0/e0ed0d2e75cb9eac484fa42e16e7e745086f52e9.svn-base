...
<body>
	...
	<div class="tm-header">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
					<a href="NotIndex.html" class="tm-site-name"><img src="images/logo2.jpg" style="position: relative;top: -25px;"></a>
				</div>
				<div class="col-lg-6 col-md-8 col-sm-9">
					...
					<ul>
						...
						<li><a href="../userweb/NomalQuestion">常见问题</a></li>
						<li><a href="#">铁路常识</a></li>
		...
		<div class="w3layouts-login" hidden id="personInfo">
			<a href="../userweb/first" id="userName">欢迎您,userName</a> <a href="#"	id="logOut" onclick="logout123()"><i> </i>注销</a>
		</div>
	</div>
	<script type="text/javascript">
		testIfLogin();
