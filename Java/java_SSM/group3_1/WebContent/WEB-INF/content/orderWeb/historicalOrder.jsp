...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
		...
		<script type="text/javascript">
			...
			function showData(result){
				document.getElementById("contentDetial").innerHTML='<tr id="name" style="background-color: #121212;color: white;opacity: 0.8;border-radius: 0;">'
				+'<td>序号</td><td>订单号</td><td>车次信息</td><td>席位信息</td><td>旅客信息</td><td>票额金额</td><td>车票状态</td><td>购票日期</td></tr>';
		...
		<div class="faq">
			<div class="container">
				<div class="agileits-news-top">
					<ol class="breadcrumb">
						<li><a href="../main/NotIndex" >主页</a></li>
						<li>	<a  href="../userweb/first">个人中心</a>
						</li>
						<li class="">查看个人信息</li>
					</ol>
				</div>
