			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-8 col-sm-9">
					...
					<ul>
						...
						<li><a href="../userweb/NomalQuestion.html">常见问题</a></li>
			...
			<div class="pay-tips mb40">
				...
				<div class="greet">
					...
					<label class="title_sty">总计退款：</label> <span class="fontcolor"
						id="total_money" name="total_money"></span> <label>出发地：</label> <label
						id="start" name="start"></label> <label>目的地：</label> <label
						id="destation" name="destation"></label> <label>座位id：</label> <label
						id="seatid" name="seatid"></label>
				</div>
				<div class="lay-btn">
