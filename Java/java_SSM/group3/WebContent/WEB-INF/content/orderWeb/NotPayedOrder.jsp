...
<script type="text/javascript">
	...
	function showData(result) {
		document.getElementById("contentDetial").innerHTML = '<!--一条订单的具体列名字--><tr id="name"'+
		'style="background-color: #121212; color: white; opacity: 0.8; border-radius: 0;">'+
				'<td>序号</td><td>订单号</td><td style="width: 100px;">车次信息</td><td>席位信息</td>'+
				'<td>旅客信息</td><td>票额金额</td><td>车票状态</td><td style="width: 100px;">购票日期</td>'+
				'<td>操作</td></tr>';
		for (var i = 0; i < result.length; i++) {
			var newNode = document.createElement("tr");
			newNode.id = "listContent"+result[i].orderId;
			newNode.innerHTML = "<td>"
					...
					+ "</td>"
					+ "<td action-able>"
					+ "<a><input onclick='continuePay("+result[i].orderId+")' class='orderSelectButton' type='button' value='继续支付'/><a><br/>"
					+ "<a><input onclick='cancelOrder("+result[i].orderId+")' class='orderSelectButton' type='button' value='取消订单'/></a>"
					+ "</td>";
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
						<a href="NotIndex.html" class="tm-site-name"><img
							src="images/logo2.jpg" style="position: relative; top: -15px;"></a>
					...
					<div class="col-lg-6 col-md-8 col-sm-9">
						...
						<ul>
							...
							<li><a href="../userweb/NormalQuestion">常见问题</a>
							</li>
	...
	<div class="faq">
		<div class="container">
			<div class="agileits-news-top">
				<ol class="breadcrumb">
					<li><a href="../main/NotIndex" >主页</a></li>
					<li><a href="../userweb/first">个人中心</a></li>
			...
			<div class="agileinfo-news-top-grids">
						...
						<div class="wthree-news-right-top">
							<ul>
								...
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>userweb/showUserInfo">查看个人信息</a></li>
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>userweb/NumberSafe">账号安全</a></li>
								<li class="new_title">常用联系人管理</li>
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>userweb/partnerSelect">常用联系人</a></li>
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>userweb/Suggest">建议与投诉</a></li>
								<li class="new_title">我的订单</li>
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>orderWeb/NotPayedOrder">未完成订单</a></li>
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>orderWeb/ungoOrder">未出行订单</a></li>
								<li class="new_subtitle"><a class="my_a"
									href="<%=basePath%>orderWeb/historicalOrder">已出行订单</a></li>
				...
				<div class="col-md-8 wthree-top-news-left">
					<div class="wthree-news-left">
						<div id="HistoryList">
							<div id="subTitle">未完成订单</div>
							<!--查询组件-->
							<div id="chaxun">
								<ul style="width: 775px;">
									<li><select name="select" id="select_cxfs" class="chaxun">
											<option id="TakeDate" value="乘车日期">乘车日期</option>
											<option id="BuyDate" value="购票日期">购票日期</option>
									</select></li>
									<li><input id="CFromDate" class="chaxun" type="date" /></li>
									<li><input id="CToDate" class="chaxun" type="date" /></li>
									<li><input id="form-control" type="text" class="chaxun"
										placeholder="订单号/车次/乘客姓名" /></li>
									<li><input id="LDDCX" type="button" class="chaxun"
										value="查 询" onclick="submit()" /></li>
								</ul>
							</div>
							<!--一条订单信息具体内容-->
							<div id="contentAList">
								...
								<table id="table_header"
									...
									<tr class="contentHeadTr">
										<td colspan="9"><img id="arrowUp" class="arrow"
											src="images/arrowup.png" onclick="hiddenOrShown(this)"
											style="display: none;" /> <img id="arrowDown" class="arrow"
											src="images/arrowdown.png" onclick="hiddenOrShown(this)"
											style="display: inline;" /> <span>订单详情</span></td>
									</tr>
								</table>
								<table id="contentDetial" border="0" cellspacing="0"
									...
									<tr id="name"
										...
										<td>序号</td>
										<td>订单号</td>
										<td style="width: 100px;">车次信息</td>
										<td>席位信息</td>
										<td>旅客信息</td>
										<td>票额金额</td>
										<td>车票状态</td>
										<td style="width: 100px;">购票日期</td>
										<td>操作</td>
									</tr>
								</table>
							</div>
							...
							<div id="pageGroup" style="display: none;">
								<div id="prePage" class="page_button">上一页</div>
								<div id="pageList">
									<ul id="pageList-ul"></ul>
								</div>
								<div id="postPage" class="page_button">下一页</div>
							</div>
