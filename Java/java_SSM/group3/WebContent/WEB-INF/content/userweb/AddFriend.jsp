	...
	<body>
		...
		<div class="faq">
			...
			<div class="cuttingLine1">
				...
				<hr style="height:1px;border:none;border-top:1px solid #0066CC;width: 200px; margin-top: -20PX;" />
				<hr style="height:1px;border:none;border-top:1px solid #0066CC;width: 200px; margin-top: -20PX; margin-right: -250px;"  />
