					...
					<div class="col-lg-6 col-md-8 col-sm-9">
						...
						<nav class="tm-nav" style="width: 600px;">
							<ul>
								...
								<li><a class="active" href="../userweb/NormalQuestion">常见问题</a></li>
		...
		<div class="faq">
			<div class="container">
				...
				<div class="agileinfo-news-top-grids">			
						<div class="wthree-news-left2">
							<div class="wthree-news-left-heading1">
								<h3>常见问题</h3>
							</div>
							<div class="wthree-news-left-heading2"></div>
							<div class="first">
								<label><b>&nbsp;&nbsp;车票</b></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">车票的种类</a></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">实名制车票</a></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">报销凭证</a></label><br /><br />
							</div>
							<div class="second">
								<label><b>&nbsp;&nbsp;购票</b></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">售票窗购票</a></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">自动售票机购票</a></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">电话订购</a></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
								<label><a href="#">互联网订票、换票</a></label><br /><br />
							</div>
							<div class="third">
								<label><b>&nbsp;&nbsp;购票</b></label><br /><br />
								<img src="images/contact.png" width="20px" height="20px" />
