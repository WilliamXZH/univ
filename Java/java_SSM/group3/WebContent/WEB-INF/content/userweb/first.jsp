		...
		<div class="header">
			...
			<div class="tm-header">
				...
				<div class="w3layouts-login">
					<a  href="first" class="active"><i class="glyphicon glyphicon-user"> </i>个人中心</a>
				</div>
			</div>
				...
				<div class="agileinfo-news-top-grids">
					...
					<div class="col-md-8 wthree-top-news-left">
						<div class="wthree-news-left">
							...
							<div class="my_image">
								<img src="images/hello.png" width="150px" height="150px" />
							</div>
							<div class="say_sth">
								<label>${userName }</label><span class="my_title">先生，您好！</span><br />
								<div class="message">
									<span class="my_subtitle">欢迎您登录中国铁路客户服务中心网站。</span><br />
									<span class="my_subwarning">如果您的密码在其他网站也使用，建议您修改本网站密码。完成手机双向核验，即可使用手机号码直接登录的新服务，解除您遗忘用户名的烦恼。</span>
								</div>
							</div>
							<div class="my_image2">
								<img src="images/train.png" width="250px" height="250px" />
							</div>
							<script>
								var paramMsg = "${param.message}";
								var msg = unescape("${message}");
								if(paramMsg != null && paramMsg != ""){
									$(".message").html( "<br /><span class='my_title'>"+paramMsg+"</span>");
								}else if(msg != null && msg != ""){
									$(".message").html( "<br /><span class='my_title'>"+msg+"</span>");
								}
							</script>
						</div>
					</div>
