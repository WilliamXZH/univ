...
<body>
	...
	<div class="tm-header">
		...
		<div class="w3layouts-login">
			<a data-toggle="modal" data-target="#myModal" href="../userweb/first">
	...
	<div class="faq">
		<div class="container">
			<div class="agileits-news-top">
				<ol class="breadcrumb">
					<li><a href="../main/NotIndex">主页</a></li>
					<li><a href="../queryInfo/QueryForTrain">查询</a></li>
					<li><a href="../userweb/first">个人中心</a></li>
					<li><a href="../orderWeb/ungoOrder">未出行订单</a></li>
	...
	<div class="content" style="min-height: 445px;">
		...
		<div class="t-succ tp-over">
			<div class="pay-tips mb40">
				...
				<div class="greet">
					<strong>退票成功！</strong> 业务流水号： <span class="colorA" id="mynum"
						name="myNum"></span>
				</div>
				<br clear="none">
				<div class="greet">

					<label class="title_sty1">乘车日期：</label> <span class="fontcolor1"
						id="DepartureDate" name="DepartureDate"></span> <label
						class="title_sty">车次：</label> <span class="fontcolor"
						id="Train_Num" name="Train_Num"></span> <label class="title_sty">票款原价：</label>
					<span class="fontcolor" id="original_cos" name="original_cos"></span>
					<br /> <label class="title_sty2">退款手续费：</label> <span
						class="fontcolor" id="Handling_charge" name="Handling_charge"></span>
					<label class="title_sty">总计退款：</label> <span class="fontcolor"
						id="total_money" name="total_money"></span>
					<label style="display: none;" >出发地：</label>
					<label id ="start"  name="start"  style="display: none;"></label>
					<label  style="display: none;">目的地：</label>
					<label  id ="destation"  name="destation" style="display: none;" ></label>
                    <label style="display: none;" >座位id：</label>
                    <label  id ="seatid"  name="seatid" style="display: none;" ></label>
				</div>
				<div class="lay-btn">
	...
	var ordernum =<%=a%>	;
		$.ajax({
					...
					success : function(result) {
						var totalmoney = 0;
						var handelMoney = 0;
						var myData = $("#DepartureDate")
								.text(result.departTime).text();
