			...
			function rec() {
				...
				$.ajax({
					...
					success:function(result){
						...
						if(result!=null){
							alert("成功");
							window.location.href="ticketOrderConfirm";
						}
					},
					error:function(){
						alert("Error!");
	...
	<body id="body_id" class="dhtmlx_winviewport  dhtmlx_winviewport dhtmlx_skin_dhx_terrace">
			...
			<div class="content" style="min-height: 445px;">
				...
				<div class="layout person">
					...
					<div id="normal_passenger_id" class="lay-bd">
								...
								<tr id="tr_id_1">
									...
									<td>
										<select id="ticketType_1" onchange="javascript:updateSeatTypeByeTickeType(this);" class="kind_of_user">
											...
											<option name="ticket_type_option" value="成人票" selected="selected">成人票</option>
						...
						<div>
							<div class="add-per">
								<div class="tc-btn createAddr theme-login am-btn am-btn-primary">新增乘客</div>
				...
				<script type="text/javascript">
					...
					function trainInfoToJson(){
						...
						trainInfo.trainName = tripTrain.serialNum;
		...
		<div class="theme-popover">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf"><strong class="am-text-default am-text-lg">新增乘客</strong> / <small>Add passenger</small></div>
			</div>
			<hr/>
				...
				<form class="am-form am-form-horizontal" action="#" method="post">
					...
					<div class="am-form-group theme-poptit">
						<div class="am-u-sm-9 am-u-sm-push-3">
							<input class="am-btn am-btn-primary " id="submit" type="button" value="保存" onclick="validateForm()" />
							<div id="closeWindow" class="am-btn am-btn-primary close">取消</div>
						</div>
